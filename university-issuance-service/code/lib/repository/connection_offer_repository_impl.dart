...
class ConnectionOfferRepositoryImpl implements ConnectionOfferRepository {
  ...
  ConnectionOfferRepositoryImpl({required IStorage storage})
    : _storage = storage;

  @override
  Future<void> createConnectionOffer(ConnectionOffer connection) {
    return _storage.put(
  ...
  Future<ConnectionOffer?> getConnectionOfferByPermanentChannelDid(
    ...
    final connection = await _storage.get(
