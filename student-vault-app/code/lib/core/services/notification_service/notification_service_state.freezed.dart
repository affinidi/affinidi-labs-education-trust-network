...
class _NotificationServiceState implements NotificationServiceState {
   _NotificationServiceState({final  Map<NotificationCounterType, int> counters = const {NotificationCounterType.contacts : 0, NotificationCounterType.connections : 0, NotificationCounterType.identities : 0, NotificationCounterType.certizen : 0}}): _counters = counters;
