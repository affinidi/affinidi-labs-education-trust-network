...
mixin _$ContactCard {
 ...
 String get id; String get firstName; String get displayName; String? get lastName; String? get email; String? get mobile; String? get profilePic; String? get cardColor;
...
@override
int get hashCode => Object.hash(runtimeType,id,firstName,displayName,lastName,email,mobile,profilePic,cardColor);
...
@useResult
$Res call({
 String id, String firstName, String displayName, String? lastName, String? email, String? mobile, String? profilePic, String? cardColor
});
...
/// Create a copy of ContactCard
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? firstName = null,Object? displayName = null,Object? lastName = freezed,Object? email = freezed,Object? mobile = freezed,Object? profilePic = freezed,Object? cardColor = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String firstName,  String displayName,  String? lastName,  String? email,  String? mobile,  String? profilePic,  String? cardColor)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ContactCard() when $default != null:
return $default(_that.id,_that.firstName,_that.displayName,_that.lastName,_that.email,_that.mobile,_that.profilePic,_that.cardColor);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String firstName,  String displayName,  String? lastName,  String? email,  String? mobile,  String? profilePic,  String? cardColor)  $default,) {final _that = this;
switch (_that) {
case _ContactCard():
return $default(_that.id,_that.firstName,_that.displayName,_that.lastName,_that.email,_that.mobile,_that.profilePic,_that.cardColor);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String firstName,  String displayName,  String? lastName,  String? email,  String? mobile,  String? profilePic,  String? cardColor)?  $default,) {final _that = this;
switch (_that) {
case _ContactCard() when $default != null:
return $default(_that.id,_that.firstName,_that.displayName,_that.lastName,_that.email,_that.mobile,_that.profilePic,_that.cardColor);case _:
  return null;
...
class _ContactCard implements ContactCard {
  const _ContactCard({required this.id, required this.firstName, required this.displayName, this.lastName, this.email, this.mobile, this.profilePic, this.cardColor});
...
/// Create a copy of ContactCard
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? firstName = null,Object? displayName = null,Object? lastName = freezed,Object? email = freezed,Object? mobile = freezed,Object? profilePic = freezed,Object? cardColor = freezed,}) {
